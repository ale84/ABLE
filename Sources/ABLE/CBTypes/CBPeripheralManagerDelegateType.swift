...
public protocol CBPeripheralManagerDelegateType: AnyObject {
    ...
    func peripheralManager(_ peripheral: CBPeripheralManagerType, didReceiveRead request: CBATTRequestType)
    func peripheralManager(_ peripheral: CBPeripheralManagerType, didReceiveWrite requests: [CBATTRequestType])
